...
store.dispatch((dispatch) => {
  ...
  axios.get(`${'http://201.2.48.240:443'}/api/aulas/`)
    .then((response) => {
...
store.dispatch((dispatch) => {
  ...
  axios.get(`${'http://201.2.48.240:443'}/api/professores/`)
    .then((response) => {
    ...
    .then(() => {
      ...
      store.dispatch((dispatch) => {
        ...
        axios.get(`${'http://201.2.48.240:443'}/api/LOCAIS/`)
          .then((response) => {
          ...
          .then(() => {
            ...
            store.dispatch((dispatch) => {
              ...
              axios.get(`${'http://201.2.48.240:443'}/api/turmas/`)
                .then((response) => {
